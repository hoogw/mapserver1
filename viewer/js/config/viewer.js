define([
    ...
    return {
        ...
        */
        ...
        {
            type: 'dynamic',
            url: 'http://maps.lacity.org/arcgis/rest/services/Mapping/NavigateLA/MapServer',
            title: i18n.viewer.operationalLayers.navigateLA,
            options: {
                id: 'navigateLA',
                opacity: 1.0,
                visible: false
        ...
        {
            type: 'dynamic',
            url: 'http://maps.lacity.org/arcgis/rest/services/Mapping/BOE_Permits/MapServer',
            title: i18n.viewer.operationalLayers.BOEpermits,
            options: {
                id: 'BOEpermits',
                opacity: 1.0,
                visible: false
        ...
        {
            type: 'dynamic',
            url: 'http://maps.lacity.org/arcgis/rest/services/Mapping/Boundaries/MapServer',
            title: i18n.viewer.operationalLayers.boundaries,
            options: {
                id: 'boundaries',
                visible: false
            }
